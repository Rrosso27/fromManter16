...
@Component({
  ...
  styleUrls: [
    './master-settlement-list.component.scss',
    '../../../assets/icon/icofont/css/icofont.scss',
  ],
  // providers: [I18n, {provide: NgbDatepickerI18n, useClass: MasterSettlementListComponent}]
})
export abstract class MasterSettlementListComponent extends NgbDatepickerI18n {
  public userModel = {
    id: 0,
    name: '',
    roles: [],
  ...
  checkHideCode: any = false; // false por defecto
  ...
  checkAllWorkForce: any = false;
  checkAllPart: any = false;
  considerDate: any = true;
  programate: any = false;
  ...
  columns = [{ name: 'Estado', prop: 'status' }];

  columnWidths = [{ column: 'status', width: 200 }];
  ...
  getWarehouses() {
    ...
    this.restService
      .getWarehousesSettlement(this.selectedRegionalId.id)
      .then((data) => {
        const resp: any = data;
        console.log(data);
        Swal.close();
  ...
  getSubCostCenter() {
    ...
    this.settlementeService
      .getSubCostCenter(this.selectedRegionalId.id)
      .then((data) => {
        console.log(data);
        const resp: any = data;
  ...
  getCenterCost() {
    ...
    //selectedCostCenterId
    this.restService
      .getCostCenterSettlement(this.selectedRegionalId.id)
      .then((data) => {
        const resp: any = data;
        console.log(data);
        Swal.close();
  ...
  getSettlementParts(ind: number) {
    ...
    if (this.estimateId) {
      this.settlementeService
        .getSettlementDetailsParts(this.estimateId)
        .then((data) => {
  ...
  getSettlementWorkforce(ind: number) {
    ...
    if (this.estimateId) {
      this.settlementeService
        .getSettlementDetailsWorkforce(this.estimateId)
        .then((data) => {
          const resp: any = data;
  ...
  getSettlementDetailCustomer(ind: number) {
    ...
    if (this.estimateId) {
      this.settlementeService
        .getSettlementDetailsCustomer(this.estimateId)
        .then((data) => {
          const resp: any = data;
  ...
  totalComparison(totalCustomer: number, totalDetail: number) {
    ...
    if (this.estimateId) {
      this.settlementeService
        .totalComparisonSettlement(this.estimateId)
        .then((data) => {
          const resp: any = data;
          console.log('datos de customer con settlemente');
          console.log(data);
    ...
    if (ind) {
      this.estimateService
        ...
        .then((data) => {
          ...
          this.itemsPart = [];
          this.itemsWorkforce = [];
          this.rowsItemsPartsApproval.forEach((item: any) => {
            console.log(item);
            ...
            this.itemPart = itemSelectInterface;
      ...
      this.estimateService
        ...
        .then((data) => {
          ...
          this.rowsItemsWorkforceApproval.forEach((item: any) => {
            ...
            this.itemWorkforce = itemSelectInterface;
  ...
  sendEmailEstimateAmazon() {
    ...
    this.uploadService
      .uploadFilesAllSettlement(
        this.blobGlobal,
        this.estimateCurrent.id,
        3,
        nameFileEstimate
      )
      .then((res) => {
  ...
  upload() {
    this.uploadService
      .uploadFileForkliftUpdate3(this.blobGlobal)
      .then((res) => {
 ...
 */
  ...
  getEmailCustomer() {
    //this.estimateCurrent.customer_id
    this.estimateService
      .getEmailsCustomer(this.estimateCurrent.customer_id)
      .then((data) => {
        const resp: any = data;
        console.log('que paso');
  ...
  assignInvoice() {
    ...
    Swal.showLoading();
    this.settlementeService
      .assingInvoice(this.invoice, this.settlementId)
      .then((data) => {
        console.log(data);
        const resp: any = data;
        console.log('envio');
        console.log(resp);
        this.settlementeService
          .updateSettlementStatus(this.estimateCurrent.id, 1)
          .then((data) => {
            const resp: any = data;
            console.log('envio');
            console.log(resp);
  ...
  sendEmailFinal() {
    ...
    for (let i = 0; i < this.emailsSend.length; i++) {
      ...
      emailsName =
        emailsName +
        this.emailsSend[i].email +
        '|' +
        this.emailsSend[i].contact;
    }
    ...
    if (this.emailsSend.length > 0) {
      this.settlementeService
        .sendSettlementEmailAmazon(
          //sendEstimateEmailAmazon
          this.estimateCurrent.elaborate_user_id,
          this.estimateCurrent.customer_id,
          this.estimateCurrent.id,
          emailsName.trim(),
          this.comment,
        ...
        .then((data) => {
          ...
          this.settlementeService
            .updateSettlementStatus(this.estimateCurrent.id, 2)
            .then((data) => {
              const resp: any = data;
              console.log('envio');
              console.log(resp);
      ...
      this.estimateService
        ...
        .then((data) => {
          ...
          this.estimateService
            .updateEstimateStatus(this.estimateCurrent.id, 1)
            .then((data) => {
              const resp: any = data;
              console.log('envio');
              console.log(resp);
  ...
  loadPdfSendEmail(ind: number) {
    ...
    doc.autoTable({
      ...
      body: [
        [
          'Sede: ' + this.regionalDescription,
          'C.Costos: ' + this.costCenterDescription,
          'OC/Cotización: Pedido No: ' + this.estimate,
        ],
      ],
    });
    ...
    if (this.rowsItemsparts.length > 0) {
      for (let i = 0; i < this.rowsItemsparts.length; i++) {
        ...
        body_table = [
          ...
          this.rowsItemsparts[i].sub_cost_center,
          this.rowsItemsparts[i].quantity,
          '$' + this.rowsItemsparts[i].price_suggest_decimal,
          this.rowsItemsparts[i].discount,
    ...
    if (this.rowsItemsWorkforce.length > 0) {
      for (let i = 0; i < this.rowsItemsWorkforce.length; i++) {
        ...
        body_table = [
          ...
          this.rowsItemsWorkforce[i].sub_cost_center,
          this.rowsItemsWorkforce[i].quantity,
          '$' + this.rowsItemsWorkforce[i].subtotal_decimal,
          this.rowsItemsWorkforce[i].discount,
          '$' + this.rowsItemsWorkforce[i].total_decimal,
        ];
    ...
    if (this.rowsItemsCustomer.length > 0) {
      for (let i = 0; i < this.rowsItemsCustomer.length; i++) {
        ...
        body_table = [
          ...
          this.rowsItemsCustomer[i].sub_cost_center,
          this.rowsItemsCustomer[i].quantity,
          '$' + this.rowsItemsCustomer[i].price_suggest_decimal,
    ...
    if (imagesLong > 0) {
      ...
      if (this.filesImage[0]) {
        img = new Image();
        this.extImageOne = String(this.filesImage[0].ext);
        src = this.filesImage[0].url;
      }
      if (this.filesImage[1]) {
        img2 = new Image();
        src2 = this.filesImage[1].url;
        this.extImageTwo = String(this.filesImage[1].ext);
      }

      if (this.filesImage[2]) {
        img3 = new Image();
        src3 = this.filesImage[2].url;
        this.extImageThree = String(this.filesImage[2].ext);
      }
      if (this.filesImage[3]) {
        img4 = new Image();
        src4 = this.filesImage[3].url;
        this.extImageFour = String(this.filesImage[3].ext);
      }
      ...
      if (this.checkHideCode == false) {
        ...
        for (let i = 0; i < this.rowsItemsWorkforce.length; i++) {
          ...
          doc.autoTable({
            ...
            columnStyles: {
              ...
              1: { halign: 'left', fontSize: 8, cellWidth: 205 },
              2: { halign: 'center', fontSize: 8, cellWidth: 27 },
              3: { halign: 'center', fontSize: 8, cellWidth: 15 },
              4: { halign: 'center', fontSize: 8, cellWidth: 15 },
              5: { halign: 'center', fontSize: 8, cellWidth: 47 },
            },
            margin: { left: 15 },
            body: [body_table],
          });
        ...
        for (let i = 0; i < this.rowsItemsWorkforce.length; i++) {
          body_table = [
            ...
            this.rowsItemsWorkforce[i].quantity,
            this.rowsItemsWorkforce[i].hour_value_decimal,
            this.rowsItemsWorkforce[i].subtotal_price,
  ...
  */
    ...
    for (let i = 0; i < this.filesImage.length; i++) {
      doc.addImage(
        this.filesImage[i].content,
        this.filesImage[i].ext,
        15,
        height,
        120,
        42
  ...
  download3(ind: number) {
    ...
    if (this.filesImage.length > 0) {
      ...
      img4.crossOrigin = '';
      img4.src = String(this.filesImage[0].url);
      var exts = this.filesImage[0].ext;
      var estimateConsecutive = this.consecutive;
      console.log(
        'este es el numero: ' + this.estimateCurrent.estimate_consecutive
      );
    } else {
      doc.save('Cotizacion_No_' + this.consecutive + '.pdf');
    }
        ...
        for (let i = 0; i < this.rowsItemsWorkforce.length; i++) {
          ...
          doc.autoTable({
            ...
            columnStyles: {
              0: { halign: 'center', fontSize: 8, cellWidth: 23 },
              1: { halign: 'left', fontSize: 8, cellWidth: 55 },
              2: { halign: 'center', fontSize: 8, cellWidth: 185 },
              3: { halign: 'center', fontSize: 8, cellWidth: 28 },
              4: { halign: 'center', fontSize: 8, cellWidth: 40 },
              5: { halign: 'center', fontSize: 8, cellWidth: 40 },
              6: { halign: 'center', fontSize: 8, cellWidth: 40 },
            },
            margin: { left: 15 },
            body: [body_table],
 ...
 img.src = src;
  ...
  getEstimateFilters() {
    if (
      ...
      this.programate == false &&
      this.selectedUserId == 0 &&
      this.selectWarehouses == 0 &&
      this.selectedCostCenter == 0 &&
      this.selectedSubCostCenter == 0 &&
      this.selectedBranchOfficeId == 0 &&
      this.selectedForkliftId == 0
    ) {
      Swal({
      ...
      if (this.considerDate) {
        ...
        var dayUntil =
          (this.untilDate.day < 10 ? '0' : '') + this.untilDate.day;
        // 01, 02, 03, ... 10, 11, 12
        let monthUntil =
      ...
      if (this.selectedBranchOfficeId != 0) {
        ...
        if (cont > 0) {
          params =
            params + '&&branch_office_id=' + this.selectedBranchOfficeId.id;
        } else {
          params =
            params + 'branch_office_id=' + this.selectedBranchOfficeId.id;
          cont++;
      ...
      if (this.selectedSubCostCenter != 0) {
        ...
        if (cont > 0) {
          params =
            params + '&&sub_cots_center_id=' + this.selectedSubCostCenter;
        } else {
  ...
  getCustomersForklift(idCustomer: number) {
    this.forkliftService
      .getForkliftsCustomer(idCustomer)
      .then((data) => {
        const resp: any = data;
  ...
  copyEstimate(row: any) {
    Swal({
      title:
        'Estás seguro que deseas copiar la cotización número ' +
        row.estimate_consecutive +
        ' ?',
  ...
  rejectEstimateFinal() {
    this.estimateService
      .updateEstimateStatus(this.estimateCurrent.id, 5)
      .then((data) => {
        const resp: any = data;
        console.log('envio');
        console.log(resp);
  ...
  finalApproval() {
    ...
    for (let i = 0; i < this.itemsFinalApproval.length; i++) {
      valuesApproval =
        valuesApproval +
        this.itemsFinalApproval[i].id +
        '@' +
        this.itemsFinalApproval[i].quantity +
        '@';
    }
    ...
    if (valuesApproval != '') {
      ...
      this.estimateService
        .approveEstimateDetails(valuesApproval)
        .then((data) => {
          const resp: any = data;
          ...
          //---------------------------
          this.estimateService
            .updateEstimateStatus(this.estimateCurrent.id, 2)
            .then((data) => {
              const resp: any = data;
              console.log('envio');
              console.log(resp);
