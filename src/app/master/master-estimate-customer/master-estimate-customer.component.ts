...
export class MasterEstimateCustomerComponent implements OnInit {
  ...
  separador:any = "."; // separador para los miles
  sepDecimal:any = ",";
    ...
    if (this.estimateId) {
      this.estimateService
        ...
        .then((data) => {
          ...
          let i:any
          for (  i = 0; i < this.rowsItems.length; i++) {
            this.itemEnd.push(
              +i +
                1 +
                "," +
  ...
  createEstimateDetail() {
    ...
    if (
      ...
      let estimateIdDetailTemp:any = this.estimateId;
  ...
  createEstimateDetailForPending(item: any, status:any) {
    Swal.fire({
      title: "Validando información ...",
      allowOutsideClick: false,
    });
  ...
  showShippingCountriesDhl(
    ...
    for (let item of this.showShippingCountriesDhlFilter) {
      ...
      if (
        ...
        console.log(item);
        console.log("extra_percentage : " + item.extra_percentage);
      }
    }
  ...
  calcularIva() {
    ...
    this.preceIvaTol1 = this.finalFormat(
      Number(this.subtotal + priceIva).toFixed(0)
    );
  }
