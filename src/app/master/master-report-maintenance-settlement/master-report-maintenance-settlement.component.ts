...
export abstract class MasterReportMaintenanceSettlementComponent extends NgbDatepickerI18n {
    ...
    this.reportService
      ...
      .then((data) => {
        ...
        for (let item of this.type) {
          let typeMaintenanceInterface:typeMaintenanceInterface = {
            id: item.id,
            name: item.description,
            select: false,
          }
          this.selectType = typeMaintenanceInterface;
