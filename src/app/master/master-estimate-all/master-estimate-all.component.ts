...
@Component({
  ...
  styleUrls: [
    './master-estimate-all.component.scss',
    '../../../assets/icon/icofont/css/icofont.scss',
  ],
  // providers: [I18n, {provide: NgbDatepickerI18n, useClass: MasterEstimateAllComponent}]
})
export abstract class MasterEstimateAllComponent extends NgbDatepickerI18n {
  public userModel = {
    id: 0,
    name: '',
    roles: [],
      ...
      this.estimateService
        ...
        .then((data) => {
          ...
          this.rowsItemsPartsApproval.forEach((item:any) => {
            ...
            this.itemPart = itemSelectInterfaceData
  ...
  sendEmailEstimateAmazon() {
    ...
    let nameFileEstimate =
      'Cotizacion_No_' + this.estimateCurrent.estimate_consecutive + '.pdf';
    console.log(this.estimateCurrent.id + ',' + 3 + ' ,' + nameFileEstimate);
    this.uploadService
      .uploadFilesAllEstimate(
        this.blobGlobal,
  ...
  sendEmailFinal() {
    ...
    if (this.subject.trim().length > 0) {
      ...
      subjectTemp =
        'Montacargas Master Cotización ' +
        this.estimateCurrent.estimate_consecutive;
    }
    ...
    console.log(
      'vamos a salir de dudas ' + this.masterEmail + '--' + this.masterName
    );
    ...
    console.log('------------------');
    console.log('estos son los correos');
    console.log(emailsName);
    console.log(this.emailsSend.length);
    console.log('---------------------');

    if (this.emailsSend.length > 0) {
      console.log('ingreso a la función YCV');
      ...
      console.log('Ingreso donde se debe validar');
      this.estimateService
        .sendEstimateEmailAmazon(
          //sendEstimateEmailAmazon
          this.estimateCurrent.elaborate_user_id,
  ...
  loadPdfSendEmail(ind: number) {
    // this.pp();
    console.log(this.creationDate + ' descargando pdf');
    ...
    if (this.checkHideCode == false) {
      ...
      doc.autoTable({
        ...
        columnStyles: {
          0: { halign: 'center', fontSize: 9, cellWidth: 23 },
          1: { halign: 'center', fontSize: 9, cellWidth: 55 },
          2: { halign: 'center', fontSize: 9, cellWidth: 175 },
          3: { halign: 'center', fontSize: 9, cellWidth: 27 },
          4: { halign: 'center', fontSize: 9, cellWidth: 45 },
          5: { halign: 'center', fontSize: 9, cellWidth: 45 },
          6: { halign: 'center', fontSize: 9, cellWidth: 42 },
        },
        margin: { left: 15 },
        body: [
  ...
  download3(ind: number) {
    ...
    doc.autoTable({
      ...
      columnStyles: {
        ...
        3: { halign: 'left', fontSize: 8, cellWidth: 80 },
        4: { halign: 'center', fontSize: 8, cellWidth: 81 },
        5: { halign: 'center', fontSize: 8, cellWidth: 81 },
        textColor: [255, 0, 0],
      },
      margin: { left: 15 },
      body: [
        ...
        [
          {
            content:
              'Montacargas Máster es AUTORRETENEDOR EN RENTA según Resolucion N°6541 del 04/09/2019',
            colSpan: 2,
            styles: { halign: 'left', textColor: [255, 0, 0] },
          },
        ],
      ],
    });
...
img.src = src;
  ...
  opp() {
    ...
    this.getImgFromUrl(logo_url, function (img:string) {
  ...
  getForklifs() {
    ...
    if (this.selectedBranchOfficeId != 0) {
      this.forkliftService
        .getForkliftBranchOfficesFull(this.selectedBranchOfficeId)
        .then((data) => {
          const resp: any = data;
          console.log(data);
          Swal.close();
  ...
  getBranchOffices() {
    ...
    if (this.selectedBusinessId != 0) {
      ...
      this.restService
        .getOffice(this.selectedBusinessId)
        .then((data) => {
          const resp: any = data;
          console.log(data);
          Swal.close();
  ...
  copyEstimateProcess(row: any, trm: any) {
    ...
    this.loadingData();
    this.estimateService
      .copyEstimate(row.id, trm, row.customer.price_margin)
      .then((data) => {
        const resp: any = data;
        console.log(resp);
  ...
  addEmail() {
    ...
    if (this.validateEmail(this.masterEmail)) {
      let emailFormatData: emailFormat = {
        email: this.masterEmail,
        contact: this.masterName,
      };
      this.emailSend = emailFormatData;
