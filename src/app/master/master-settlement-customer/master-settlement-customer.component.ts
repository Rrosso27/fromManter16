...
@Component({
  ...
  styleUrls: [
    "./master-settlement-customer.component.scss",
...
export class MasterSettlementCustomerComponent implements OnInit {
  ...
  quantityUpdate  :any= 1;
  unitCostUpdate :any= 0;
  weightUpdate: any = 0;
  weightTypeListUpdate = 0;
  priceListUpdate :any= 0;
  ...
  managementVariables:any = 0;
  managmentTariff :any= 0;
  finalWeight:any = 0;
  ...
  salePrice:any = 0;
  salePriceUpdate:any = 0;
  costTotalGlobal:any = 0;
  costPesosGlobal :any = 0;

  fileWidth: any;

  costTotalGlobalUpdate:number = 0;
  costPesosGlobalUpdate:number = 0;
  ...
  showSettlementId :any = true;
  showCreateItem :any = false;
  showSaveFile :any = false;
  lowPrice: any;
  higherPrice: any;
  ...
  getEstimateDetails() {
    if (this.settlementId) {
      this.estimateService
        .getEstimateDetails(this.settlementId)
        .then((data) => {
          const resp: any = data;
  ...
  getEstimateWorkforce() {
    if (this.settlementId) {
      this.estimateService
        .getEstimateDetailsWorkforce(this.settlementId)
        .then((data) => {
          const resp: any = data;
  ...
  getEstimateParts() {
    if (this.settlementId) {
      this.estimateService
        .getEstimateDetailsParts(this.settlementId)
        .then((data) => {
          const resp: any = data;
  ...
  createEstimateDetail() {
    ...
    console.log(
      "--->" + priceTemp + "---" + this.lowPrice + "--" + this.higherPrice
    );
    console.log(
      "-----" +
        Number(priceTemp) +
        "--->=----" +
        Number(this.lowPrice) +
        "----&&----" +
        Number(priceTemp) +
        "---<=---" +
        Number(this.higherPrice)
    );
    if (
  ...
  public downloadPdf() {
    const doc = new jsPDF();
    let specialElementHandlers:any = {
...
// doc.html(content2, {
//   callback: (doc) => {
//     doc.output( specialElementHandlers);
...
// });
  ...
  normalize(element: string) {
    var from:any = "ÃÀÁÄÂÈÉËÊÌÍÏÎÒÓÖÔÙÚÜÛãàáäâèéëêìíïîòóöôùúüûÑñÇç",
  ...
  uploadImagesEstimate() {
    let file:any
    for ( file of this.selectedFilesImages) {
  ...
  uploadFiles() {
    let fileCurrent:any
    for ( fileCurrent of this.selectedFiles) {
      const file:any = fileCurrent[0];
      console.log(file);
      //  const uuid = UUID.UUID();
      // console.log(uuid);
      ...
      let nameTemp = this.removeAccents(
        this.consecutive + file.name.replace(/\s/g, "")
      );
      ...
      console.log(extension);
      this.uploadService
        .uploadFilesAll(file, this.settlementId, 0, nameTemp)
        .then((res) => {
          console.log("s3info" + JSON.stringify(res));
          this.s3info = res;
          console.log(this.s3info);
  ...
  uploadFilesImages() {
    ...
    let fileCurrent:any
    for ( fileCurrent of this.selectedFilesImages) {
      ...
      this.uploadService
        .uploadFilesAll(img, this.settlementId, 1, nameTemp)
        .then((res) => {
          console.log("s3info" + JSON.stringify(res));
          this.s3info = res;
          console.log(this.s3info);
...
*/
    ...
    doc.autoTable({
      ...
      columnStyles: {
        0: { cellWidth: 100, fontSize: 9, fillColor: "2" },
        1: { fontSize: 9, halign: "left", fillColor: "2", cellWidth: 100 },
        2: { fontSize: 9, halign: "left", fillColor: "2", cellWidth: 214 },
      },
      margin: { left: 15 },
      body: [
        [
  ...
  createSettlement() {
    ...
    this.settlementService
      .createSettlement(
        ...
        "",
        0,
        selectedRegionalIdTemp,
        selectedCostCenterIdTemp,
        selectedWarehouseIdTemp,
        numberEstimateTemp,
        branchOfficeTemp,
        ...
        this.settlementService
          ...
          .then((data) => {
            ...
            this.router.navigateByUrl(
              "maintenance/settlementCustomerUpdate/" + this.settlementId
            );
